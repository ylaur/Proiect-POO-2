/**
 * ============================================================================
 * PROIECT OOP: JOC VIDEO RPG INTERACTIV (v3.0 - Editie Extinsa)
 * ============================================================================
 * Cerinte tehnice implementate la sange:
 * 1. Separare Logica (Interfete Non-Virtuale - NVI)
 * 2. Mostenire pe 3 niveluri: Entitate -> Erou -> Cavaler, Print, Arcas, Magician
 * 3. Functii virtuale pure & Constructori virtuali (clone)
 * 4. Gestiunea resurselor (Rule of 3: Copy Constructor, Op=, Destructor)
 * 5. Pointeri la clase de baza (Erou detine Arma*)
 * 6. Downcasting (dynamic_cast) cu sens (Activari pasive specifice in lupta)
 * 7. Ierarhie de Exceptii (JocError, InputInvalid, ResurseInsuficiente, ConfigurareInvalida) derivata din std::exception
 * 8. Atribute/Metode Statice (Contor entitati globale, Contor Runda)
 * 9. Utilizare STL (std::vector, std::string, std::swap, algoritmi de randomizare)
 * 10. Const-correctness & Encapsulare (Getteri const, metode de afisare const)
 * ============================================================================
 */
...
// =============================================================================
// SECTIUNEA 1: IERARHIA DE EXCEPTII
// =============================================================================
...
// =============================================================================
// SECTIUNEA 2: IERARHIA ARMA (Compozitie pentru Erou)
// =============================================================================
...
// =============================================================================
// SECTIUNEA 4: IERARHIA ENTITATE -> EROU & INAMIC
// =============================================================================
...
// -----------------------------------------------------------------------------
// Clasa intermediara abstracta: Erou
// -----------------------------------------------------------------------------
...
public:
    ...
    // 3. Assignment Operator (Corectat pentru clasa abstracta)
...
private:
    ...
    int citesteInt() {
        int val;
        while (!(std::cin >> val)) {
            // 1. Resetam cin-ul ca sa functioneze din nou
            std::cin.clear();

            // 2. Aruncam la gunoi ce a scris utilizatorul gresit (maxim 10K caractere)
...
public:
    ...
    void fazaMagazin() {
        ...
        while (inMagazin) {
            ...
            std::cin.ignore(10000, '\n'); // Curata ENTER-ul ramas invizibil pe teava de la cin >>
            std::cin.get();               // Asteapta sa apesi tu ENTER din nou
        }
    }
